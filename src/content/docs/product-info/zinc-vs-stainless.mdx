...
If an attached object will be removed during the off-season or between uses, see [Protecting Anchor Threads from Debris During Seasonal Storage](/installation/protecting-anchor-threads/) for set screw sizes and instructions.
