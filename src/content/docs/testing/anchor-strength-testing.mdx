...
Above an 80°F pavement temperature, measured pull capacity appears to decline by approximately 10–15% for each additional 10°F, with installation-to-installation variation. At elevated temperatures, the asphalt itself softens, reducing the support it provides around the cured adhesive and anchor.

This is an operating-temperature effect, separate from the adhesive temperature limits during installation. Account for the pavement temperature when the anchor will be under load, not just the air temperature when it is installed.
