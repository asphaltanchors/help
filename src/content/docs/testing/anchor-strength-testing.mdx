...
Hot pavement reduces the support that the asphalt provides around the cured adhesive and anchor. Our current measurements provide a reference curve for the Sonoma PG64-16 test pavement, but binder grade, mix characteristics, pavement condition, and temperature through the anchor depth can change performance.

This is an operating-temperature effect, separate from the adhesive temperature limits during installation. See [High Pavement Temperature and Anchor Capacity](/testing/high-pavement-temperature/) for our measured relationship, uncertainty range, and preliminary binder-grade scenarios.
