...
Asphalt softens as its temperature increases. Above an 80°F pavement temperature, our measured pull capacity appears to decline by approximately 10–15% for each additional 10°F, with installation-to-installation variation. Users should account for reduced holding capacity when the pavement will be hotter than 80°F while the anchor is under load.
